  ...
  const universityData = [
    {
      ...
      requirements: {
        undergraduateFoundation: "Valid Passport, Proof of address, Share Code (not British), Home Office Travel Document (Refugee), CV, Level 3 (60 credits) or Work experience (1 year).",
        undergraduateStandard: "Valid Passport, Proof of address, Share Code (not British), Home Office Travel Document (Refugee), CV, Level 3 (120 credits).",
        workRoute: "Currently employed or employed in past 24 months (min 1 year or ongoing). Relevant transferable skills (not cleaning, construction, security, beauty, taxi driving etc.). CV: Job title, Company (website), Roles/responsibilities, Employment dates, Referee (business email & phone). Admissions verifies. Work experience only applications considered for foundation year degree.",
      },
    },
    {
      id: "uclan",
    ...
    },
    {
      ...
      requirements: {
        standardEntry: "104 UCAS Points. Level 3 subjects. Five GCSEs C/4+ (inc. English & Maths).",
        foundationEntry: "48 points for Foundation Year.",
        documents: "Passport, Proof of address, Share Code (EU Settlement/refugee, non-British), Travel Doc (Refugee), CV, Level 3 (60 credits) or Work exp (1 year).",
    ...
    },
    {
      ...
      requirements: {
        foundationDegree: "56 UCAS tariff points (Level 3). Max 6 pts L3 Key Skills. GCSE C/4 Maths & English (or L2 Key Skills). IELTS 6.0 (5.5 each).",
        postgraduate: "2:2 Hons degree or equiv. IELTS 6.0 (5.5 each).",
        apl: "Credit for past learning/work exp. possible.",
        documents: "Valid Passport, Final Certificate & Transcripts, Proof of Address (Recent), Personal statement (350 words), EU Settlement Status (Only EU students), Standard CV (FdA only).",
      },
    },
    {
      id: "gbs",
      ...
      requirements: {
        topUp: "Passport/ID, Proof of residence (if not British passport), POA, HND (L5 cert+transcript). Must have GBS HND Business.",
        undergraduate: "18+. L3 qual (60 credits/80 UCAS). 5 GCSEs 4/C (inc English). Interview. 21+: Welcome if alternative evidence of commitment/experience. Interview.",
        ...
        postgraduateIntl: "Campus interview. Degree 2:2. 300-word Personal Statement. CEFR Level B2 English. 1000 word reflective task. APEL process.",
      },
    },
    {
      id: "lsc",
      ...
      requirements: {
        ...
        exemptions: "OPT Exemptions: GCSE English C/4+; Functional Skills English L2 Pass; Adult Literacy L2 Oxford Cambridge Pass.",
        age: "Age < 21 (18-20): L2 qual for Foundation; L3 cert for Cert HE.",
        documents: "Clear POA (within 3 months, address 1h30m travel max). Clear Passport/ID/Driving licence (both sides). Share code + E-visa. Pre-settle: +3 months' pay slips/invoices + Bank statements. Self-employed: UTR. Good personal statement/SOP (correct Uni & Course name). Updated CV (work exp, Edu History). Unemployed: state. Missing Edu cert: state 'Cannot provide'. Agent consent & T&C form (signed). Travel Document for refugees.",
      },
    },
  ];
